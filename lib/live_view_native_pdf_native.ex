defmodule LiveViewNativePdfNative do
  @moduledoc """
  ...
  import LiveViewNativePdfWeb, only: [verified_routes: 0]
  ...
  def live_view() do
    quote do
      use LiveViewNative.LiveView,
        ...
        layouts: [
          swiftui: {LiveViewNativePdfWeb.Layouts.SwiftUI, :app}
        ]
  ...
  defp helpers(format) do
    ...
    core_component_module = Module.concat([LiveViewNativePdfWeb, CoreComponents, plugin.module_suffix])
