defmodule LiveViewNativePdfWeb.CoreComponents.SwiftUI do
  @moduledoc """
  ...
  of the `LiveViewNativePdfWeb.CoreComponents` functions you should expect identical functionality for similarly named
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LiveViewNativePdfWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LiveViewNativePdfWeb.Gettext, "errors", msg, opts)
    end
  end
